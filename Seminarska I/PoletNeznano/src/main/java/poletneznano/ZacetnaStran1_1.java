 ...
 * @author anjabrelih
 */
public class ZacetnaStran1_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dateDep1 = new com.toedter.calendar.JDateChooser();
        dateRet1 = new com.toedter.calendar.JDateChooser();
        ...
        dateDep1.setBackground(new java.awt.Color(204, 255, 255));
        dateDep1.setDateFormatString("dd MMM yyyy");
        dateDep1.setFont(new java.awt.Font("Montserrat", 1, 15)); // NOI18N
        dateDep1.setMaxSelectableDate(new java.util.Date(253370764894000L));
        dateDep1.setMinSelectableDate(new java.util.Date(-62135769506000L));

        dateRet1.setBackground(new java.awt.Color(204, 255, 255));
        dateRet1.setDateFormatString("dd MMM yyyy");
        dateRet1.setFont(new java.awt.Font("Montserrat", 1, 15)); // NOI18N
        dateRet1.setMaxSelectableDate(new java.util.Date(253370764894000L));
        dateRet1.setMinSelectableDate(new java.util.Date(-62135769506000L));
            ...
            .addGroup(datePanelLayout.createSequentialGroup()
                ...
                .addGroup(datePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(datePanelLayout.createSequentialGroup()
                        ...
                        .addGap(161, 586, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, datePanelLayout.createSequentialGroup()
                        .addGroup(datePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(datePanelLayout.createSequentialGroup()
                                .addComponent(dateDep1, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(dateRet1, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(datePanelLayout.createSequentialGroup()
            ...
            .addGroup(datePanelLayout.createSequentialGroup()
                ...
                .addGroup(datePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(datePanelLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(datePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(dateDep1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(dateRet1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(datePanelLayout.createSequentialGroup()
                        .addGap(15, 15, 15)
    ...
    private void btnIskanjeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIskanjeActionPerformed
        ...
        if(airportA.isEmpty() || airportB.isEmpty() || dateRet.getDate() == null || dateDep.getDate() == null || dateRet1.getDate() == null || dateDep1.getDate() == null){
            if(airportA.isEmpty()){
                // set bg to light red
            ...
            if(dateRet1.getDate() == null){
                // set bg to light red
                dateRet1.setBackground(new Color(255, 204, 203));
            }
            else{
                // set bg back to normal
                dateRet1.setBackground(new Color(204,255,255));
            }
            if(dateDep1.getDate() == null){
                // set bg to light red
                dateDep1.setBackground(new Color(255, 204, 203));
            }
            else{
                // set bg back to normal
                dateDep1.setBackground(new Color(204,255,255));
            }
            ...
            Date dateA1 = dateDep1.getDate();
            Date dateB = dateRet.getDate();
            Date dateB1 = dateRet1.getDate();
            
            String strDateA = DateFormat.getDateInstance().format(dateA);
            String strDateA1 = DateFormat.getDateInstance().format(dateA1);
            String strDateB = DateFormat.getDateInstance().format(dateB);
            String strDateB1 = DateFormat.getDateInstance().format(dateB1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZacetnaStran1_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZacetnaStran1_1().setVisible(true);
            }
        });
    }
    ...
    private com.toedter.calendar.JDateChooser dateDep1;
    private javax.swing.JPanel datePanel;
    private com.toedter.calendar.JDateChooser dateRet;
    private com.toedter.calendar.JDateChooser dateRet1;
